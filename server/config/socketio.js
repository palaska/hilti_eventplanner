...
function onConnect(socket) {
  ...
  require('../api/kokteyl/kokteyl.socket').register(socket);
  require('../api/yemek/yemek.socket').register(socket);
  require('../api/basketball/basketball.socket').register(socket);
  require('../api/football/football.socket').register(socket);
